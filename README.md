...
| Skill | Description |
|-------|-------------|
| **architecture** | Diagnose architecture from real change pressure, let the human choose between deeper module designs, encode the choice as an executable architecture contract, and checkpoint bounded agent work for drift. Standalone or conditional stage of pair; supplies strategic practice for soc. |
