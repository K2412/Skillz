...
Automatic workflow-memory ordinary runs are active for `pair`, `architecture`, and `implement`. Other skills do not use this protocol unless a later release explicitly adds them.
