...
- **`/lets-talk`** — Think a decision, tradeoff, or open question through *with* the user in conversation — grounded in the real artifacts, opinionated, and deliberately…
...
- **`/scrub`** — Scrub a set of code changes clean before they go up for review — strip personal scaffolding and comment noise so the diff reads like it was written…
